...
export default function WhatsAppFAB() {
  return (
    <a
      ...
      className="fixed bottom-6 right-4 z-30 w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform"
